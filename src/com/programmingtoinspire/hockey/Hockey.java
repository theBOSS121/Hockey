package com.programmingtoinspire.hockey;
...
import com.programmingtoinspire.hockey.game.Game;
import com.programmingtoinspire.hockey.input.Keyboard;

public class Hockey extends Canvas implements Runnable {
	...
	public void run() {
		...
		while (running) {
			...
			if(System.currentTimeMillis() - timer > 1000){
				timer += 1000;
				frame.setTitle("Hockey " + updates + " updates, " + frames +" frames");
				updates = 0;
				frames = 0;
			}
		}
